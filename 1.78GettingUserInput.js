...
function register() {
    var username = document.getElementById("usernameInput").value; //!
    document.getElementById("message").innerHTML = username + ", you're signed up!"; //!  ex: Isaac, you're signed up!
}
...
/*----------------------------------*/
// why do we need a button and a function to access user input from an "inpu" element?
